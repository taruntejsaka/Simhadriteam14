(function($) {
    ...
    kingster_sf_menu.prototype = {
        ...
        init_slidebar: function() {
            ...
            $(window).on('kingster-navigation-slider-bar-animate', function() {
                t.animate_slidebar_pos();
            });
            ...
            $(window).on('scroll kingster-set-sticky-navigation', function() {
                ...
                if (!t.sticky_nav.hasClass('kingster-fixed-navigation')) {
                    ...
                    if ($(window).scrollTop() + page_offset > t.sticky_nav.offset().top) {
                        ...
                        setTimeout(function() {
                            t.sticky_nav.addClass('kingster-animate-fixed-navigation');
                        }, 10);
                        setTimeout(function() {
                    ...
                    if ($(window).scrollTop() + page_offset <= placeholder.offset().top) {
                        ...
                        setTimeout(function() {
                            t.sticky_nav.removeClass('kingster-animate-fixed-navigation');
                        }, 10);
                        setTimeout(function() {
                            t.sticky_nav.css('height', '');
                            $(window).trigger('kingster-navigation-slider-bar-animate');
